...
export default function Reminders() {
     ...
     const fetchUpcomingNotifications = async () => {
          try {
               const response = await fetch("https://spendanalyzer-production-37c5.up.railway.app/notification/upcoming", {
                    method: "GET",
                    headers: {
                         "Content-Type": "application/json"
                    },
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await fetch("https://spendanalyzer-production-37c5.up.railway.app/notification/add", {
                    method: "POST",
                    headers: {
                         "Content-Type": "application/json"
                    },
     ...
     const handleRead = async (id) => {
          ...
          try {
               const response = await fetch(`https://spendanalyzer-production-37c5.up.railway.app/notification/read/${id}`, {
                    method: "PUT",
                    headers: {
                         "Content-Type": "application/json"
                    },
     ...
     const handleDelete = async () => {
          ...
          try {
               const response = await fetch(`https://spendanalyzer-production-37c5.up.railway.app/notification/delete/${deleteItemId}`, {
                    method: "DELETE",
                    headers: {
                         "Content-Type": "application/json"
                    },
